...
echo ""
echo "NOTE: The following helper scripts are baked into the AMIs:"
echo "  Flink:     /opt/flink-job/restart.sh, stop.sh, start.sh"
echo "  Generator: /opt/telco-generator/start.sh"
echo "  If you change these scripts, you must re-create the AMIs."
